...
* 🖼️ **Better JPEG quality** — JPEG is encoded through **WIC** instead of legacy GDI+, giving visibly cleaner text edges and faster encoding at the same quality setting.
